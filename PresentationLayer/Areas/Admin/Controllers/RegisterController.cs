        ...
        public async Task<IActionResult> SignUp(AppUserRegisterDto appUserRegisterDto) //AppUserRegisterDto bu modeli kullanma amacımız sadece gerekli propertyleri kullanmak için 
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    MailboxAddress mailboxAddressFrom = new MailboxAddress("Çiftlikköy Restaurant", "scakar542@gmail.com");//kimden geleceği isim ve adres
                    ...
                    mimeMessage.Subject = "Onay Kodu";//konu kısmı
                    ...
                    client.Authenticate("scakar542@gmail.com", "ayny upod zimi yote");//mail ve mailde oluşturduğun güvenlik kodu
